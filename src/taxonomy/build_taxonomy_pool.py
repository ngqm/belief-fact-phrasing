...
from src.utils.general import get_full_cot, extract_mcq_answer


def main():
    """Sample per-cell CoTs from the logs and write the classifier pool JSONL."""
                ...
                for t, items in by_type.items():
                    ...
                    for f, d in pick:
                        ...
                        item = {
                            ...
                            "correct": d.get("ground_truth", "").strip() == extract_mcq_answer(text),
                        }
