...
from src.utils.models import MODELS, is_qwen3, load_model_eager, build_prompt
...
def run(model, tok, queries, gold, is_q3, max_new):
    """Generate answers for a set of queries and return (accuracy, n_parsed)."""
...
def main():
    """Run the answer-position control across permutations and templates, writing JSON."""
    ...
    tok, model = load_model_eager(hf_id)
