"""Matplotlib helpers for the per-verb accuracy and answer-distribution plots."""
...
def plot_performance(analysis_base, visualization_base, prompt_template, records):
    """Plot factual vs false accuracy per model for each verb, saving a CSV and PNGs."""
...
def plot_performance_am_x_confident(analysis_base, visualization_base, prompt_template, records):
    """Plot accuracy vs stated confidence level per model for the am_X_confident verbs."""
