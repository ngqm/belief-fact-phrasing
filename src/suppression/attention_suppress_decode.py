...
is lowered while the model generates the CoT and answer. Reducing source
attention at decode time lets the model treat the proposition as background
data rather than content to fact-check.
